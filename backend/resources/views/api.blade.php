...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script>
            const API_BASE_URL = 'http://inventory.dsscheck.test:8000/api';
            const API_URL = 'http://inventory.dsscheck.test:8000';
            // const API_BASE_URL = 'http://172.16.144.149:8000';
            // const API_URL = 'http://172.16.144.149:8000/api';

            function updateLinks() {
                document.getElementById('back-home').href = `${API_BASE_URL}`;
                document.getElementById('get-all-inventories').href = `${API_URL}/getAllInventories/108381`;
                document.getElementById('get-inventories').href = `${API_URL}/getInventories`;
                document.getElementById('get-count-inventories').href = `${API_URL}/getCountInventories`;
                document.getElementById('get-locations').href = `${API_URL}/getLocations`;
                document.getElementById('get-all-check-histories').href = `${API_URL}/getAllCheckHistories/9`;
                document.getElementById('get-check-histories').href = `${API_URL}/getAllCheckHistories`;
            }
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <h1 class="text-lg text-gray-600 dark:text-gray-400 font-semibold cursor-default">
                        <a href="#" id="back-home" class="text-gray-900 dark:text-white"><- Back</a>
                    </h1>
                </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="#" id="get-all-inventories" class="text-gray-900 dark:text-white">GET: getAllInventories</a>
                                </div>
                            </div>
                        </div>
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="#" id="get-inventories" class="text-gray-900 dark:text-white">GET: getInventories</a>
                                </div>
                            </div>
                        </div>
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="#" id="get-count-inventories" class="text-gray-900 dark:text-white">GET: getCountInventories</a>
                                </div>
                            </div>
                        </div>
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="#" id="get-locations" class="text-gray-900 dark:text-white">GET: getLocations</a>
                                </div>
                            </div>
                        </div>
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="#" id="get-all-check-histories" class="text-gray-900 dark:text-white">GET: getAllCheckHistories</a>
                                </div>
                            </div>
                        </div>
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="#" id="get-check-histories" class="text-gray-900 dark:text-white">GET: getCheckHistories</a>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="version-info text-sm text-gray-500">
